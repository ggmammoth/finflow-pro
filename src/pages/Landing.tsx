    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="flex gap-2">
          {user ? (
            ...
            <>
              ...
              <Link to="/register"><Button size="sm" className="gap-1.5"><Sparkles className="h-3 w-3" /> Get Started</Button></Link>
            </>
          )}
        </div>
      </nav>
      ...
      <section className="mx-auto max-w-3xl px-6 py-20 text-center md:py-32">
        ...
        <p className="mx-auto mt-5 max-w-xl text-base leading-relaxed text-muted-foreground md:text-lg">
          Track income, expenses, and recurring payments. Beautiful charts, smart insights, and full control over your money.
        </p>
        <div className="mt-8 flex justify-center gap-3">
          ...
          {!user && (
            <Link to="/login">
              <Button size="lg" variant="outline" className="h-11 px-7">Sign In</Button>
            </Link>
          )}
        </div>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-6 pb-20">
        <div className="grid gap-4 md:grid-cols-3">
          {[
            { icon: BarChart3, title: 'Smart Dashboard', desc: 'Charts and summaries for instant clarity on financial health.' },
            { icon: RefreshCw, title: 'Recurring Tracking', desc: 'Never miss a bill. Track subscriptions and recurring payments.' },
            { icon: Shield, title: 'Secure & Private', desc: 'Encrypted and protected. Only you access your data.' },
          ].map((f, i) => (
